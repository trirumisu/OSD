...
class Tool(object):
    def __init__(self):
        ...
        self.label = "Optimal Supply-Demand analysis"
        self.description = "Optimal Supply-Demand analysis"
    ...
    def execute(self, parameters, messages):
        ...
        for i in results:
            writer.writerow(i)
        f.close()
        fnso=parameters[0].value
        ref_name=arcpy.Describe(fnso).spatialReference.factoryCode
        sr = arcpy.SpatialReference(ref_name)
